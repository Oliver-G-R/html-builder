  ...
  5: [
    {
      ...
      availableTags: [
        ...
        { id: 'li', label: '<LI>', category: 'list' },
        { id: 'li2', label: '<LI>', category: 'list' },
        { id: 'li3', label: '<LI>', category: 'list' },
        { id: 'ul', label: '<UL>', category: 'list' },
        { id: 'dl', label: '<DL>', category: 'list' },
      ],
      slots: [
        { id: 's1', label: 'Lista ordenada (numerada)', expectedTagId: 'ol', indent: 0 },
        { id: 's2', label: 'Primer elemento', expectedTagId: 'li', indent: 1 },
        { id: 's3', label: 'Segundo elemento', expectedTagId: 'li2', indent: 1 },
        { id: 's4', label: 'Tercer elemento', expectedTagId: 'li3', indent: 1 },
      ],
      explanation: '<OL> (Ordered List) crea una lista numerada. Cada elemento va dentro de <LI> (List Item). La numeración la pone el navegador automáticamente.',
    },
    {
      type: 'multiple-choice',
  ...
  6: [
    {
      ...
      slots: [
        { id: 's1', label: 'Etiqueta de enlace', expectedTagId: 'a', indent: 0 },
        { id: 's2', label: 'Destino del enlace', expectedTagId: 'href_attr', indent: 1 },
        { id: 's3', label: 'Abrir en nueva pestaña', expectedTagId: 'target_attr', indent: 1 },
      ],
      explanation: 'La etiqueta <A> (Anchor) crea enlaces. HREF define el destino. TARGET="_BLANK" abre en nueva pestaña.',
    },
    {
      type: 'multiple-choice',
  ...
  7: [
    {
      ...
      availableTags: [
        ...
        { id: 'td', label: '<TD>', category: 'table' },
        { id: 'td2', label: '<TD>', category: 'table' },
        { id: 'th', label: '<TH>', category: 'table' },
        { id: 'caption', label: '<CAPTION>', category: 'table' },
      ],
      slots: [
        { id: 's1', label: 'Tabla completa', expectedTagId: 'table', indent: 0 },
        { id: 's2', label: 'Título de tabla', expectedTagId: 'caption', indent: 1 },
        { id: 's3', label: 'Fila de la tabla', expectedTagId: 'tr', indent: 1 },
        { id: 's4', label: 'Primera celda', expectedTagId: 'td', indent: 2 },
        { id: 's5', label: 'Segunda celda', expectedTagId: 'td2', indent: 2 },
      ],
      explanation: 'Una tabla HTML se construye con <TABLE>, filas <TR> y celdas <TD>. <CAPTION> añade un título. <TH> crea celdas de encabezado (negrita y centrado).',
    },
    {
      type: 'multiple-choice',
  ...
  8: [
    {
      ...
      slots: [
        { id: 's1', label: 'Etiqueta de marquesina', expectedTagId: 'marquee', indent: 0 },
        ...
        { id: 's4', label: 'Color de fondo', expectedTagId: 'bgcolor_attr', indent: 1 },
      ],
      explanation: '<MARQUEE> crea texto en movimiento. direction puede ser left, right, up o down. behavior puede ser scroll, slide o alternate.',
    },
    {
      type: 'multiple-choice',
